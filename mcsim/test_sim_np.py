...
def test_calculate_distance2():
    coords_3 = np.array([[0, 0, 0], [0,0,2]])
    coords_4 = np.array([[0, 0, 1], [0,0,0]])
    expected_value = np.array([1,2])

    calculated_value = mc.calculate_distance(coords_3, coords_4)
    
    assert np.array_equal(expected_value, calculated_value)

def test_calculate_distance3():
    coords_3 = np.array([[0, 0, 0], [0,0,9]])
    coords_4 = np.array([0, 0, 1])
    expected_value = np.array([1,2])

    calculated_value = mc.calculate_distance(coords_3, coords_4, 10)
