...
"""
@pytest.mark.parameterize('variable_name1, variable_name2, ... , variable_nameN', [
    (variable_value1, variable_value2, ... , variable_valueN),
    (variable_value1, variable_value2, ..., varuable_valueN)
]
)
...
@pytest.mark.parametrize("point1, point2, expected_distance, box_length", [
    ([0, 0, 0], [1, 0, 0], 1, None),
    ([0, 0, 0], [8, 0, 0], 8, None),
    ([0, 0, 0], [8, 0, 0], 2, 10),  #define 3 test cases for test
])
def test_calculate_many(point1, point2, expected_distance, box_length):
