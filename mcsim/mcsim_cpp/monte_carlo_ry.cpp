...
bool accept_or_reject(double delta_e, double beta)
{
    ...
    {
        double random_number = random_double(0, 1.0);
...
Coordinates run_simulation(Coordinates coordinates, double box_length, double cutoff,
...
int main(void)
{
    ...
    AtomCoord coord1 = {0,0,0};
    AtomCoord coord2 = {0,0,8};
    std::cout << calculate_distance(coord1,coord2) << std::endl;
    //std::cout << calculate_distance({})
    Coordinates coords2 = {{{0,0,0}, {0,0,pow(2.0, 1.0/6.0)}, {0,0, 2.0 *pow(2.0, 1.0/6.0)}}};
    ...
    std::cout << "Test calcualte_tail_correction: " 
                << calculate_tail_correction(coords.size(), box_length, 3) << std::endl;

    Coordinates coords3;
    coords3.push_back({0,0,0});
    coords3.push_back({0,0,pow(2.0, 1.0/6.0)});
    coords3.push_back({0,0, 2.0 *pow(2.0, 1.0/6.0)});

    std::cout << "Test calculate pair energy: "
                << calculate_pair_energy(coords3, 1, 10.0, 3) << std::endl;
